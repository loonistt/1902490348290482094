...
% Убираем жирный шрифт только для заголовков, но сохраняем правильные команды
\usepackage{titlesec}
\titleformat{\section}
  {\normalfont\large\centering} % было \normalfont\large\bfseries\centering
  {\thesection}
  {1em}
  {}
...
\dottedcontents{section}[4em]{\normalfont}{4em}{1pc} % было \bfseries
